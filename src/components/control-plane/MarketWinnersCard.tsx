...
const WinnerItem = ({ winner, index }: { winner: MarketWinner; index: number }) => {
  ...
  return (
    <AccordionItem value={`winner-${index}`} className="border-border">
  ...
  return (
    <Card className="card-terminal" style={{ boxShadow: 'var(--shadow-soft)' }}>
      <CardHeader className="pb-4">
        <CardTitle className="text-sm font-semibold text-foreground font-mono uppercase tracking-wider flex items-center gap-2">
      ...
      <CardContent className="space-y-6">
        ...
        {hasEmerging && (
          <div>
            <div className="flex items-center gap-2 mb-3">
            <Badge className="badge-warning flex items-center">
