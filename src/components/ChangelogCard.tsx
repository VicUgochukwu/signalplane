...
export function ChangelogCard({ entry }: ChangelogCardProps) {
  return (
    <Card className="group rounded-xl border border-border/50 bg-card hover:border-[hsl(var(--accent-signal)/0.2)] hover:shadow-md transition-all duration-200">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="text-muted-foreground hover:text-accent-signal transition-colors opacity-0 group-hover:opacity-100"
              >
      ...
      <CardContent className="space-y-3">
        ...
        {entry.implication && (
          <p className="text-sm text-muted-foreground italic border-l-2 border-[hsl(var(--accent-signal)/0.2)] pl-3">
            {entry.implication}
          </p>
        )}
