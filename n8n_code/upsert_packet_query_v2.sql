...
VALUES (
    ...
    '{{ JSON.stringify($json.packet.action_mapping || {}).replace(/'/g, "''") }}'::jsonb
)
...
SET packet_title = EXCLUDED.packet_title, exec_summary = EXCLUDED.exec_summary, sections = EXCLUDED.sections,
    key_questions = EXCLUDED.key_questions, bets = EXCLUDED.bets, predictions = EXCLUDED.predictions, action_mapping = EXCLUDED.action_mapping
RETURNING id;
