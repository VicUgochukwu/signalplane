// Score + Select Top Signals v3 (with all 10 signal types)
// Includes: messaging, narrative, icp, horizon, objection, pricing, proof, distribution, hiring, launch_decay
// Max per section varies by ship, max 40 total
...
// All sections including new ships
const sections = [
...
// Build system prompt with strict JSON schema (updated for all signal types)
